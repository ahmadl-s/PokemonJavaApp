...
Scanner input = new Scanner(System.in);
    	...
    	System.out.println("WELCOME TO POKEMON GA-OLE  " + player1.getName() + " and your current Ga-Olemedal is: "+player1.getMedals());
        ...
        System.out.println("\n This Pokemons might appear in the game: ");
        ...
        System.out.println("\n------------------------------------");
        System.out.println("\nYou chose as your FIRST Pokémon: " + firstChoice);
        System.out.println("You chose as your SECOND Pokémon: " + secondChoice);
        ...
        System.out.println("\n======================================================\n");
        System.out.println("\033[1m     --------------SEE YOUR ENEMIES------------     \033[0m \n Click Enter");
        String ShowWildPokemons = input.nextLine();
        

        while (!ShowWildPokemons.equalsIgnoreCase("W")) {
            System.out.print("Enter 'W' to see Enemies (WildPokemons): ");
            ShowWildPokemons = input.nextLine();

            if (ShowWildPokemons.equalsIgnoreCase("W")) {
            	System.out.println("\n=======================================\n");
                System.out.println("You will be facing This WildPokemons: \n");
                System.out.println(wildPokemon1 +"\n"+ wildPokemon2); //This will show random Wildpokemon 
                System.out.println("\n=======================================\n");
            } else {
        ...
        while (!BattleDetails.equalsIgnoreCase("B")) {
            System.out.print("Click 'B' to view Battle Details: ");
            BattleDetails = input.nextLine();

            if (BattleDetails.equalsIgnoreCase("B")) {

            	
                System.out.println("\n\033[1m---Your Pokemon That you Chose---\033[0m \n");
                System.out.println("1--" + firstChoice);
                System.out.println("2--" + secondChoice);
                
                System.out.println("\n\033[1m---Wild Pokemon(Enemy)---\033[0m \n");
     ...
     // Input for the first battle pokemon
        System.out.println("\n\nWhich Pokemon do you choose for First Battle (Enter '1' or '2'): ");
        ...
        System.out.println("\n===========================================\n");
        System.out.println("LET THE SECOND BATTLE BEGIN ---------the pokemons that you didn't choose");
        System.out.println("\n=======================================\n");
        ...
        System.out.println("Player Score: " + BattleScore.getPlayerscore());
        System.out.println("Opponent Score: " + BattleScore.getOpponentscore());
        
        //the score is calculated by the last Damage(PlayerDamge or OpponentDamge) done by the pokemon that won
        
        
        
        //Save user in Text
        String filePath = "C:\\Users\\alawa\\eclipse-workspace\\ObjectOrientedProject\\src\\pokemonGame\\TopScoreList";
        

        try (FileWriter writer = new FileWriter(filePath, true)) { 
            writer.write(name + " - " + BattleScore.getPlayerscore() + "\n");
            System.out.println("Player score saved successfully! Check File(TopScoreList)");
        } catch (IOException e) {
